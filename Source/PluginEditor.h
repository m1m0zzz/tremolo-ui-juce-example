...
/**
 */
class TremoloJUCEExampleAudioProcessorEditor : public juce::AudioProcessorEditor {
 public:
  TremoloJUCEExampleAudioProcessorEditor(TremoloJUCEExampleAudioProcessor&);
  ~TremoloJUCEExampleAudioProcessorEditor() override;
 ...
 private:
  ...
  TremoloJUCEExampleAudioProcessor& audioProcessor;
  ...
  JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(
      TremoloJUCEExampleAudioProcessorEditor)
};
