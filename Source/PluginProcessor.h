...
/**
 */
class TremoloJUCEExampleAudioProcessor : public juce::AudioProcessor {
 public:
  //==============================================================================
  TremoloJUCEExampleAudioProcessor();
  ~TremoloJUCEExampleAudioProcessor() override;
 ...
 private:
  ...
  juce::SmoothedValue<float, juce::ValueSmoothingTypes::Linear> panAngleSmoothed;
  ...
  //==============================================================================
  JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(TremoloJUCEExampleAudioProcessor)
};
